...
<body id="body">
    ...
    <header>
        <section class="serch_heder">
            ...
            <div class="cart">
                <a href="#" target=""> <i class=" fa fa-cart-plus " aria-hidden="true "></i>
                </a>
            </div>
            </div>
            <div class="changeDir">
            ...
            <div class="checkout">
                <div class="product_list">
                    <div class="product">
                        ...
                        <div class="note ">
                            <p>
                                <span>ملاحظة</span>هذا الكتاب رقمي وسيتم توصيله من خلال البريد الإلكتروني</p>
...
<script src="../assests/js/ImageModling.js "></script>
